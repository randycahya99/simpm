    ...
    <body>
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item {{$aktif}}" style="background-image: url('/landing/{{$fotos->foto}}')">
                        <div class="carousel-caption d-none d-md-block">
                            ...
                            <p class="lead">{{$fotos->deskripsi}}</p>
                        </div>
                    </div>
        ...
        <section class="py-5 text-center">
            <div class="container"> 
                ...
                <p class="text-muted mb-5 text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste possimus tempora vitae maxime, quos optio, consequuntur numquam laborum aut a beatae expedita, accusantium quas ea molestiae quia odit voluptates fuga. Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis ipsum rem magnam quam et veritatis repudiandae. Eaque iusto minus itaque vitae debitis repellat obcaecati fuga eligendi tenetur, labore corporis assumenda.</p>
            </div>
        </section>
        <section class="py-5 text-center">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-4 mb-3">
                        ...
                        <h6>Lorem</h6>
                        <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem aliquam impedit adipisci quia minima neque sit possimus totam, debitis sed consequatur rem consectetur itaque explicabo aut minus reprehenderit beatae ut?</p>
                    </div>
                    <div class="col-sm-6 col-lg-4 mb-3">
                        <svg class="lnr text-primary services-icon">
                            <use xlink:href="#lnr-screen"></use>
        ...
        {{-- <section class="main">
            <div class="container mt-4">
                <h1 class="text-center mb-4 p-4 text-secondary" id="products">Produk Tenant Kami</h1>
                <div class="row">
